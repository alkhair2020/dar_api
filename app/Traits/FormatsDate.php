...
trait FormatsDate
{
    ...
    private function formattedDate($dateValue)
    {
        ...
        return Carbon::parse($this->inUsersTimezone($dateValue))->format('Y-m-d') ;
    }
    ...
    private function formattedTime($dateValue)
    {
        ...
        return Carbon::parse($this->inUsersTimezone($dateValue))->format('g:i a') ;
    }
    ...
    public function toLocalTime($field = null )
    {
        ...
        $dateValue = is_null($this->{$field}) ? Carbon::now($userTimezone) : $this->{$field};
